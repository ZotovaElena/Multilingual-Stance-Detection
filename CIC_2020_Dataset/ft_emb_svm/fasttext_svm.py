...
file_name = 'Fasttext_Not_Lemma/FT_CV_esp_report.csv'
...
file_name = "Fasttext_Not_Lemma/FT_esp_test_report.csv"
...
tweets_test.to_csv("Fasttext_Not_Lemma/FT_esp_test_predicted.csv", sep='\t', encoding='utf-8', index=False)
