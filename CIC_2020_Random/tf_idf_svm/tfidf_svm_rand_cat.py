...
clf = Pipeline(
    [  ("filter", SelectKBest(mutual_info_classif, k=num_features)),
       ("classification", svm.SVC(kernel="rbf", gamma=0.001, C=500)),
    ]
)
...
tweets_train.to_csv('experiments_with_users/SVM_CV_predicted_exp_rand.csv', encoding='utf-8', index=False)
...
wrong_prediction.to_csv('experiments_with_users/SVM_CV_wrong_predicrion_exp_rand.csv', encoding='utf-8', index=False)
...
file_name = "experiments_with_users/SVM_test_report_exp_rand.csv"
...
tweets_test.to_csv("experiments_with_users/SVM_test_predicted_exp_rand.csv", sep='\t', encoding='utf-8', index=False)
...
wrong_prediction_test.to_csv("experiments_with_users/SVM_test_wrong_prediction_exp_rand.csv", encoding='utf-8', index=False)
